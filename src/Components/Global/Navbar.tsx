...
const Navbar: React.FC<NavbarProps> = ({ onAddEmployee }) => {
  ...
  return (
    <>
      ...
      {/* Sign Out Confirmation Dialog - Fixed at viewport center */}
      {showSignOutDialog && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-[9999]">
          ...
          {/* Dialog Container - Fixed at center */}
          <div 
          ...
          >
            <div className="p-6">
              ...
              <div className="flex justify-end gap-3">
                <button
                  className="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 font-medium transition-colors duration-200"
                  onClick={() => setShowSignOutDialog(false)}
                >
                  Cancel
                </button>
                <button
                  className="px-4 py-2 rounded-md bg-red-600 text-white hover:bg-red-700 font-medium transition-colors duration-200"
